	...
	<section id="header">
		...
		<div>
			<ul id="navbar">
				...
				<li><a class="active" href="kadaorbangles.jsp">KADA/BANGLES</a></li>
		...
		<div id="mobile">
			<a href="login.html"><i class="fa fa-user-plus"></i></a> <a
				href="cart.html"><i class="fa fa-shopping-bag"></i></a> <i id="bar"
				class="fas fa-outdent"></i>
		</div>
	</section>

	<section id="page-header5"></section>

	<section id="product1" class="section-p1">
		<p>New Modern Designs</p>

		<div class="pro-container">
			<div class="pro" onclick="window.location.href='sproduct.';">
